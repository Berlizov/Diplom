...
@XmlSeeAlso({UsersTypes.class, User.class,Task.class,Subtask.class,Sprint.class})
public class Packet {
    public API func;
    ...
    public static Packet xmlParse(String xml) throws JAXBException {
    ...
    public String xmlGenerate() throws JAXBException {
